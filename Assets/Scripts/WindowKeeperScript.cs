...
public class WindowKeeperScript : MonoBehaviour
{
    public static WindowKeeperScript Instance { get; private set; }
    ...
    private bool AssignTopmostWindow(string WindowTitle, bool MakeTopmost)
    {
    ...
    public void ToggleTopmost(string WindowTitle) {
        _isTopmost = true;
        AssignTopmostWindow(WindowTitle, _isTopmost);
    } 
